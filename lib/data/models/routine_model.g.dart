...
_$RoutineModelImpl _$$RoutineModelImplFromJson(
  ...
  sourceType:
      $enumDecodeNullable(_$RoutineSourceTypeEnumMap, json['source_type']) ??
...
Map<String, dynamic> _$$RoutineModelImplToJson(_$RoutineModelImpl instance) =>
    <String, dynamic>{
      ...
      'source_type': _$RoutineSourceTypeEnumMap[instance.sourceType]!,
...
const _$RoutineSourceTypeEnumMap = {
  RoutineSourceType.preset: 'PRESET',
