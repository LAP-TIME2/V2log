...
### ~~Phase 1.5~~ — Phase 2A 직행으로 불필요
> IWF 컬러 인식: 보너스 경로 (헬스장 80-90% 검정 플레이트)
...
| # | 항목 | 상태 | 상세 |
|---|------|------|------|
| 1 | Roboflow 공개 데이터셋 다운로드 | ✅/❌ | 21,688장 (무게 라벨 없음, 사전학습용) |
| 2 | 사진 수집 (3,000~5,000장) | ✅/❌ | 직접 촬영, 무게별 라벨 포함 |
| 3 | 클래스 분류 | ✅/❌ | ⚠️ 미확정 (9개 vs 3개+OCR) |
| 4 | Roboflow 프로젝트 | ✅/❌ | |
| 5 | 수동 라벨링 (500장) | ✅/❌ | |
| 6 | 자동 라벨링 + 수정 | ✅/❌ | |
| 7 | 데이터 증강 (×3배, Roboflow 공식 한도) | ✅/❌ | |
| 8 | Colab 환경 셋업 | ✅/❌ | |
| 9 | **YOLO26-N** 학습 | ✅/❌ | (기존 YOLO11에서 변경) |
| 10 | .pt → .tflite 변환 | ✅/❌ | |
...
| 2 | weight_detection_service.dart | ✅/❌ | |
| 3 | model.tflite 앱 내장 | ✅/❌ | |
| 4 | **Two-Stage 파이프라인** | ✅/❌ | 무게 감지 모드 ↔ Pose-only 모드 |
| 5 | **무게 자동 적용** (팝업 없음) | ✅/❌ | 화면에 조용히 표시, 틀리면 탭 수정 |
| 6 | **자동 세트 시작** (첫 동작 감지) | ✅/❌ | 버튼 0개 UX |
| 7 | **자동 세트 종료** (무동작 감지) | ✅/❌ | 휴식 타이머 자동 시작 |
| 8 | 플레이트 등록 UI | ✅/❌ | B2C 선택 / B2B 관리자 |
| 9 | OCR 숫자 읽기 (보조) | ✅/❌ | Google ML Kit v2 검토 |
| 10 | workout_screen 무게 콜백 | ✅/❌ | |
| 11 | B2B Fine-tuning 파이프라인 | ✅/❌ | |
